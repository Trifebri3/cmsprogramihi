...
class IconHelper
{
    public static function getIcons(): array
    {
        return [
            ...
            'leaf' => [
                'name' => 'Leaf / Eco-friendly',
                'svg' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m12.728 12.728l.707-.707M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />'
            ],
            'water' => [
                'name' => 'Water drop / Hydro',
                'svg' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.07 15.11a2 2 0 00-1.022.547V20a2 2 0 002 2h12a2 2 0 002-2v-4.572zM12 11V3m0 0l-3 3m3-3l3 3" />'
            ],
            'book' => [
                'name' => 'Book / Education',
            ...
            'star' => [
                'name' => 'Star / Award',
                'svg' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.907c.969 0 1.371 1.24.588 1.81l-3.97 2.883a1 1 0 00-.364 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.971-2.883a1 1 0 00-1.178 0l-3.97 2.883c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.364-1.118L2.49 10.11c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />'
            ],
            'pin' => [
            ...
            'sprout' => [
                ...
                'svg' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10V22M12 10C12 10 9.5 8.5 7.5 10C5.5 11.5 6 14 6 14C6 14 8.5 14 10.5 12.5C12.5 11 12 10 12 10ZM12 10C12 10 14.5 8.5 16.5 10C18.5 11.5 18 14 18 14C18 14 15.5 14 13.5 12.5C11.5 11 12 10 12 10Z" />'
            ]
        ];
    }

    public static function getSvg(string $key, string $class = 'w-6 h-6'): string
    {
        $icons = self::getIcons();
        $inner = $icons[$key]['svg'] ?? $icons['medical']['svg'];
        return '<svg class="'.$class.'" fill="none" stroke="currentColor" viewBox="0 0 24 24">' . $inner . '</svg>';
    }
}
